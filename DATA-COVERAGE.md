...
- **What QUORUM uses it for**: self-registration. QUORUM's four agents (Scout / Judge / Executor / Treasurer) each register on ERC-8004 Day 7, making the agent mesh discoverable in the same registry judges and external agents are watching.
