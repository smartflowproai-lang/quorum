...
function loadTreasurerKey() {
  ...
  throw new Error("TREASURER_PRIVATE_KEY env var not set. Run with: TREASURER_PRIVATE_KEY=0x... node attestation-tx.mjs (or set TREASURER_ENV_FILE to a .env file containing it).");
}
